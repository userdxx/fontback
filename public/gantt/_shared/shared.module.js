import { WidgetHelper, AjaxHelper, DomHelper, IdHelper, Tooltip, Toast, BrowserHelper, StringHelper, LocaleManager, Localizable, DataGenerator, Fullscreen, Events, GlobalEvents, VersionHelper, EventHelper, Popup, ResizeHelper, Rectangle, Widget } from '../../build/gantt.module.js?440867';
...
const
    ...
    isModule         = pathName.endsWith('module.html') || (moduleTag && moduleTag.src.includes('app.module.js?440867')) || (pathName.endsWith('index.html') && isOnline),
    ...
    startRootCause() {
        ...
        window.logger = new RC.Logger({
            ...
            onBeforeLog(data) {
                ...
                if (data.isJsError && (!data.file || !data.file.includes('.js?440867') || data.file.includes('chrome-extension'))) {
                    return false;
                }
            },
...
class CodeEditor extends Popup {
            ...
            tbar : [
                {
                    ...
                    ref      : 'filesCombo',
                    editable : false,
                    value    : isModule ? 'app.module.js?440867' : isUmd ? 'app.umd.js?440867' : 'app.js?440867',
                    items    : [
                        isModule ? 'app.module.js?440867' : isUmd ? 'app.umd.js?440867' : 'app.js?440867'
                    ],
    ...
    async loadCode(filename = isModule ? 'app.module.js?440867' : isUmd ? 'app.umd.js?440867' : 'app.js?440867') {
        const
            me = this;
        ...
        if (filename.endsWith('.js?440867')) {
            me.mode = 'js';
            code = me.processJS(code);
        }
        else if (filename.endsWith('.css?440867')) {
            me.mode = 'css';
    ...
    updateDownloadLink() {
        ...
        downloadLink.href = `data:text/${this.filename.endsWith('.css?440867') ? 'css' : 'javascript'};charset=utf-8,${escape(this.codeElement.innerText)}`;
    }
    ...
    static async addToPage(button) {
        ...
        if (document.head.querySelector('[href$="app.css?440867"]')) {
            filesStore.add({ text : 'resources/app.css?440867', value : 'resources/app.css?440867' });
        }
