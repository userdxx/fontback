...
var TrialPanel = /*#__PURE__*/function (_bryntum$gantt$Popup) {
  _inherits(TrialPanel, _bryntum$gantt$Popup);
  ...
  _createClass(TrialPanel, [{
    ...
    value: function addToMailList() {
      ...
      trackingField.value = bryntum.gantt.BrowserHelper.getCookie('aw');
    ...
    value: function triggerDownload() {
      ...
      var a = bryntum.gantt.DomHelper.createElement({
      ...
      if (!me.gaScript) {
        me.gaScript = bryntum.gantt.DomHelper.createElement({
          parent: document.head,
          tag: 'script',
          async: 'true',
          src: 'https://www.googletagmanager.com/gtag/js?id=UA-11046863-1',
...
;
bryntum.gantt.BryntumWidgetAdapterRegister.register('trialpanel', TrialPanel);